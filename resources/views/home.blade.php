<x-layouts.main_layout pageTitle="home">
    ...
    <section
        ...
        <div
            class="absolute top-5 left-5 sm:top-10 sm:left-10 w-20 h-20 sm:w-32 sm:h-32 border-4 sm:border-8 border-gray-900 rotate-12 opacity-10">
        </div>
        <div
            class="absolute bottom-10 right-5 sm:bottom-20 sm:right-10 w-24 h-24 sm:w-40 sm:h-40 bg-orange-400 opacity-20 -rotate-6">
        </div>
        <div
            class="absolute top-1/2 right-1/4 w-16 h-16 sm:w-24 sm:h-24 border-4 sm:border-8 border-orange-500 opacity-15 hidden sm:block">
        </div>
        ...
        <div class="max-w-5xl w-full px-4 sm:px-8 py-6 sm:py-12 relative z-10">
            ...
            <div
                class="inline-block mb-4 sm:mb-6 
            ...
            <div
                class="mt-6 sm:mt-8 mb-4 sm:mb-6 
                        p-4 sm:p-6 
                ...
                <p class="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-900 font-bold leading-tight">
                    O Catálogo Definitivo da <span
                        class="bg-amber-300 px-2 py-1 inline-block rotate-[-1deg]">Crocância</span>
                </p>
            </div>

            {{-- Descrição - Melhor legibilidade mobile --}}
            <p
                class="text-base sm:text-lg lg:text-xl text-gray-700 font-medium max-w-2xl mb-8 sm:mb-10 leading-relaxed">
        ...
        <div
            class="absolute bottom-0 left-0 right-0 h-2 sm:h-4 bg-gradient-to-r from-orange-400 via-amber-300 to-orange-500">
        </div>

    </section>

    {{-- Comentários Recentes --}}
    <section class="w-full py-12 sm:py-16 lg:py-20 bg-white border-y-4 sm:border-y-6 border-gray-900">
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div class="text-center mb-8 sm:mb-12">
                ...
                <h2 class="text-2xl sm:text-3xl lg:text-4xl font-black text-gray-900 uppercase">
                    Comentários Recentes
                </h2>

                <p class="text-base sm:text-lg text-gray-700 font-medium mt-3 sm:mt-4">
                    Veja o que a galera está falando agora!
                </p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                    ...
                    @foreach ($recentComments as $comment)
                        <article
                            ...
                            <div
                                class="h-[160px] sm:h-[180px] w-full bg-white border-b-4 sm:border-b-6 border-gray-900 relative overflow-hidden">
                                ...
                                <a href="{{ route('web.snacks.show', $comment->snack_id) }}" class="block mb-3">
                                    <h3
                                        class="text-base sm:text-lg font-black text-gray-900 leading-tight 
                                               hover:text-orange-600 transition-colors line-clamp-2">
                                        {{ $comment->snack->name }}
                                    </h3>
                                </a>
                ...
                <div class="text-center mt-8 sm:mt-12">
                    <a href="{{ route('web.snacks.list') }}"
                        class="inline-flex items-center gap-2 
                              ...
                              border-b-3 sm:border-b-4 border-transparent hover:border-orange-500 
                              transition-all duration-200 uppercase tracking-wide px-2">
                        Ver todos os salgadinhos →
                    </a>
                </div>
            @else
                {{-- Estado vazio --}}
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                ...
                <div
                    ...
                    <div
                        class="w-12 h-12 sm:w-16 sm:h-16 bg-orange-500 border-4 border-gray-900 
                                flex items-center justify-center mb-4 sm:mb-6 rotate-3">
                        <svg class="w-6 h-6 sm:w-8 sm:h-8 text-gray-900" fill="none" stroke="currentColor"
